...
class IngresoTendencias : ComponentActivity() {
...
fun PantallaTendencias() {
    Scaffold(
        topBar = { BarraSuperiorTendencias() },
        bottomBar = { BarraInferiorTendencias() },
...
fun GraficoBarras() {
    Column(
        ...
        Text(
            text = "Ingresos de la primera semana del mes",
            fontSize = 12.sp,
            fontWeight = FontWeight.Bold,
            color = Color.Black,
        ...
        Canvas(
            ...
            val categories = listOf("Semana 1", "Semana 2", "Semana 3", "Semana 4", "Semana 5")
            val colors = listOf(
                Color(0xFF92D050),
                Color(0xFFFFA500),
                Color(0xFF7F7F7F)
            ...
            val barWidth = size.width / (categories.size * barsPerDay + categories.size + 1) // + espacio entre días
        ...
        Row(
            ...
            LeyendaItem(color = Color(0xFF92D050), texto = "Trabajo")
            LeyendaItem(color = Color(0xFFFFA500), texto = "Familia")
            LeyendaItem(color = Color(0xFF7F7F7F), texto = "Beca")
        }
    }
}
...
@Composable
fun FilaResumenTendencias(icono: String, texto: String, colorFondo: Color) {
    Row(
        verticalAlignment = Alignment.CenterVertically,
